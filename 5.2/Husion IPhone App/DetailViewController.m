...

{
    ...
    //scrollView.contentSize=CGSizeMake(background.frame.size.width, background.frame.size.height);
    NSLog(@"scroll view size width: %f, height %f", scrollView.frame.size.width,scrollView.frame.size.height);
...
- (IBAction)SegmentValueChanged:(id)sender {
    if ([sender selectedSegmentIndex]==0){
        ...
        //NSLog(@"scrollview size width: %f height: %f", scrollView.frame.size.width, scrollView.frame.size.height);
